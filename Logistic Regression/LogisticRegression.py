...
class LogisticRegression:
    ...
    def confusion_matrix(self,X,y,t=0.5):
        ...
        TP = np.sum((y==class_0) & (y_predicted == class_0))
        FP = np.sum((y==class_0) & (y_predicted == class_1))
        TN = np.sum((y==class_1) & (y_predicted == class_0))
        FN = np.sum((y==class_1) & (y_predicted == class_1))
